...
public class VerifyAgreement {
	...
	public void TC001_VerifyPermanentAgreementSections() throws Exception {
		...
		logger = report.startTest("Verify Part A with failed");
		try{
		    //Assertion to be placed here
			Assert.assertTrue(paratext.contains("Part A – Chartezzzzr of Aged Care Rights"), "Part A verification failed.");
		    logger.log(LogStatus.PASS, "Pass");
		} catch(AssertionError e) {
			logger.log(LogStatus.FAIL, "Fail");
		}
